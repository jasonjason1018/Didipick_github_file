						...
						<div class="col-lg-2 col-md-3 col-6">
							<div class="widget">
								...
								<ul class="list-unstyled iconlist ml-0">
									...
									<li><a href="/didipick_cart">購物車</a></li>
									@endif
									<li><a href="/didipick_qa">常見問題</a></li>
									<li><a href="/didipick_shoppingprocess">購物流程</a></li>
								</ul>
				...
				$(document).ready(function(){
					$.ajax({
						...
						success:function(resp){
							//$("#cartquantity").html(resp);
							if(resp != 'nosession'){
								$("#cartquantity").text(resp);
							}
						}
					});
				})
