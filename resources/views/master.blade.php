				...
				<div class="container">
					...
					<div>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page"><a href="master.php">達人勸敗 / 主題列表</a></li>
						</ol>
					</div>
					<h1>達人勸敗</h1>
							...
							<div class="grid-inner row no-gutters">
									...
									<div class="feature-box media-box">
										<div class="fbox-media Darkbg">
											...
											<div class="pickbgpadding">
												<a href="/didipick_master_info/{{$master->id}}"><img src="/storage/{{$master->img}}" alt=""></a> 
											</div>
										</div>
									</div>
								</div>
								<div class="col-md-8 pl-md-4">
									<div class="entry-title title-sm">
										<h3><a href="/didipick_master_info/{{$master->id}}">{{$master->title}}</a></h3>
									</div>
									...
									<div class="entry-meta">
										<ul>
											...
											<li><a href="#"><i class="icon-user"></i> {{$master->author}}</a></li>
										</ul>
									</div>
									<div class="entry-content">
										<p>{!!$master->outline!!}</p>
										<div class="align_r">
											<a href="/didipick_master_info/{{$master->id}}" class="more-link ">Ｍore ⇒</a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="clear"></div>
							...
							<div class="center">
								<ul class="pagination pagination-transparent pagination-circle">
									...
									<li class="page-item"><a href="javascript:void(0)" class="page-link" aria-label="Next" onclick="changepage()"><span aria-hidden="true">«</span></a></li>
									
									<li class="page-item "><a href="javascript:void(0)" class="page-link" onclick="changepage()">1</a></li>
