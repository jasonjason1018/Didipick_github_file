					...
					<div class="header-row justify-content-lg-center header-border">
						...
						<nav class="primary-menu with-arrows ">
							...
							<ul class="menu-container justify-content-between">
								<li class="menu-item current mega-menu-one">
			...
			<div class="content-wrap">
				<div class="container">
					...
					<div class="row gutter-40 pickingbox">
						...
						<div class="entry col-12 masblogbox" data-animate="fadeInUp" data-delay="100">
							<div class="grid-inner row no-gutters">
								...
								<div class="col-md-8 pl-md-4">
									...
									<div class="entry-content">
										<p>不用洗頭，不用吹風機，就可以讓你的每一根頭髮都充滿空氣蓬鬆！<br/>
										使用方法：將ponpon粉撲在出油軟榻或者需要增加蓬鬆感的區域，5下左右後迅速抓開至蓬鬆，白色粉末會逐漸變透明，並吸收油和汗，不用擔心會殘留白色，終於不洗頭也能Get到蓬鬆有型的髮型啦！</p>
										<div class="align_r">
						...
						<div class="masterad">
							<div class="masterad_item">
								<a href="#"><img src="images/masterad_1.jpg" alt=""></a>
							</div>
							<div class="masterad_item">
								<a href="#"><img src="images/masterad_2.jpg" alt=""></a>
							</div>
							<div class="masterad_item">
								<a href="#"><img src="images/masterad_3.jpg" alt=""></a>
							</div>
							<div class="masterad_item">
								<a href="#"><img src="images/masterad_4.jpg" alt=""></a>
							</div>
						</div>
