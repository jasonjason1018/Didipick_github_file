								...
								<div class="page-menu-row">
									...
									<nav class="page-menu-nav">
										<ul class="page-menu-container">
											...
											<li class="page-menu-item current"><a href="member_edit.html" title="會員資料">會員資料</a></li>
									...
									<div class="chform">
										...
										<form class="row mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post" novalidate="novalidate">
											...
											<div class="col-12 form-group">
												...
												<input type="text" id="template-contactform-email" name="template-contactform-email" value="" class="sm-form-control valid">
											</div>
							...
							<div class="sidebar-widgets-wrap">
								...
								<div class="widget widget_links product_lbox">
									...
									<ul>
										...
										<li><a href="member_edit.html" title="會員資料" class="active">會員資料</a></li>
