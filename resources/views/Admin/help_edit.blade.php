...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
  ...
  <tr>
    <td width="100%"><input type="button" value="回上頁" name="new" onclick="window.location='/help'"></td>
  </tr>
  <!--<tr>
  ...
  <tr>-->
    <tr>
    <td width="100%">
    	<form method="POST" action="/help_edit_update" name="Links" enctype="multipart/form-data" id="product_edit_form">
    		@csrf
    <table border="1" cellpediting="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
    	@foreach($data as $v)
		  ...
		  <tr>
		    ...
		    <td width="82%"><textarea name="content" id="content" rows="4" cols="60" class="form-controller">{{$v->content}}</textarea></td>
		  </tr>
