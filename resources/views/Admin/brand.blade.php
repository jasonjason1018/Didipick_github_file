...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
  ...
  <tr>
    <td width="100%"><input type="button" value="新增" name="new" onclick="window.location='/brand_new'"></td>
  </tr>
  ...
  <tr>
    ...
    <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2">
      ...
      <tr>
        <td width="10%" bgcolor="#C0C0C0" align="center"><font size="2">品牌Logo</font></font></td>
        <td width="15%" bgcolor="#C0C0C0" align="center"><font size="2">品牌大圖</font></font></td>
      ...
      <tr>
        ...
        @else
          <input type="button" value="開啟" name="open" onclick="window.location='/brand_open/{{$v->sno}}'">
        @endif
        <input type="button" value="刪除" name="delete" onclick="window.location='/brand_delete/{{$v->sno}}'">
        </td>
      </tr>
      @endforeach
    </table>
