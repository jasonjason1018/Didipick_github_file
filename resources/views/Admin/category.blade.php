...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
  ...
  <tr>
    <td width="100%"><input type="button" value="新增" name="new" onclick="window.location='/category_new'"></td>
  </tr>
  ...
  <tr>
    ...
    <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2">
      ...
      <tr>
        <td width="10%" bgcolor="#C0C0C0" align="center"><font size="2">icon</font></font></td>
      ...
      <tr>
        ...
        <input type="button" value="商品編輯" name="update" onclick="window.location='/category_edit/{{$v->sno}}'">
          @if($v->status==1)
          <input type="button" value="關閉" name="close" onclick="window.location='/category_off/{{$v->sno}}'">
        @else
          <input type="button" value="開啟" name="open" onclick="window.location='/category_open/{{$v->sno}}'">
        @endif
        <input type="button" value="刪除" name="delete" onclick="window.location='/category_delete/{{$v->sno}}'">
        </td>
      </tr>
      @endforeach
    </table>
