...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
  ...
  <tr>
    ...
    @endif
  <tr>
    <td width="100%"><input type="button" value="回上頁" name="new" onclick="window.location='{{$url}}'"></td>
  </tr>
  <!--<tr>
  ...
  <tr>-->
    <tr>
    <td width="100%">
    	<form method="POST" action="/qa_edit_update" name="Links" enctype="multipart/form-data" id="product_edit_form">
    		@csrf
