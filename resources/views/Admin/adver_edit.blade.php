...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
  ...
  <tr>-->
    <tr>
    <td width="100%">
    	<form method="POST" action="/adver_edit_update" name="Links" enctype="multipart/form-data" id="product_edit_form">
    		@csrf
		  ...
		  <tr>
		    ...
		    <td width="82%">
		    	...
		    	@else
		    		...
		    		<button><a href="/adver_img/{{$img}}" target="_blank">圖片</a></button>
		    		<button><a href="/adver_delete_edit_img/{{$img}}/{{$v->sno}}">刪除</a></button>
		    	@endif
		    </td>
		  </tr>
		  <tr>
