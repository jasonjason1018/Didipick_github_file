...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
  ...
  <tr>
    <td width="100%"><input type="button" value="回上頁" name="new" onclick="window.location='/label'"></td>
  </tr>
  <!--<tr>
  ...
  <tr>-->
    <tr>
    <td width="100%">
    	<form method="POST" action="/label_edit_update" name="Links" enctype="multipart/form-data" id="product_edit_form">
    		@csrf
    <table border="1" cellpediting="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
    	@foreach($data as $v)
		  <tr>
		    <td width="18%" bgcolor="#C0C0C0" align="center"><font size="2">標籤名稱</font></td>
		    <td width="82%"><input type="text" id="label" name="label" value="{{$v->name}}"></td>
		  </tr>
		  <tr>
		    <td width="18%" bgcolor="#C0C0C0" align="center"><font size="2">瀏覽次數</font></td>
		    <td width="82%"><input type="text" id="views" name="views" value="{{$v->views}}"></td>
		  </tr>
		    <td width="100%" colspan="2">
		    	<input type="hidden" name="sno" value="{{$v->id}}">
