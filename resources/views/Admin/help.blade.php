...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
  ...
  <tr>
    <td width="100%"><input type="button" value="新增" name="new" onclick="window.location='/help_new'"></td>
  </tr>
  ...
  <tr>
    ...
    <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2">
      ...
      <tr>
        ...
        <input type="button" value="編輯" name="update" onclick="window.location='/help_edit/{{$v->id}}'">
        @if($v->status == 1)
          <input type="button" value="關閉" name="close" onclick="window.location='/help_off/{{$v->id}}'">
        @else
          <input type="button" value="開啟" name="open" onclick="window.location='/help_open/{{$v->id}}'">
        @endif
        <input type="button" value="刪除" name="delete" onclick="window.location='/help_delete/{{$v->id}}'">
      </tr>
      @endforeach
    </table>
