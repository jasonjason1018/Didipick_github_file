...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
  ...
  <tr>-->
    <tr>
    <td width="100%">
    	<form method="POST" action="/master_edit_update" name="Links" enctype="multipart/form-data" id="product_edit_form">
    		@csrf
    	...
    	@foreach($data as $value)
    	  <tr>
			...
			@else
			    ...
			    <input type="button" value="刪除" name="delete" onclick="window.location='/master_delete_edit_img/{{$img}}/{{$sno}}'"><br>
		    @endif
			</td>
		  <tr>
