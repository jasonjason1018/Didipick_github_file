								...
								<div class="page-menu-row">
									...
									<nav class="page-menu-nav">
										<ul class="page-menu-container">
											<li class="page-menu-item current"><a href="member.html" title="會員總覽" class="active">會員總覽</a></li>
					...
					<div class="row gutter-40 col-mb-40">
						...
						<div class="postcontent col-lg-9 order-lg-last">
							...
							<div class="reimbursebox">
								...
								<h4>本月您再完成 <b>10</b> 筆訂單即可享有星星會員！</h4>
								...
								<div class="row post-navigation addvaluebox">
									...
									<div class="addvaitem_c col-md-7">NT. 1,000</div>
									<div class="addvaitem_r col-md-2">
										<a href="order_addvalue.html" class="button button-border button-rounded button-green m-0">儲值</a>
									</div>
									<hr class="valueline"/>
									</small>
								</div>
						...
						<div class="sidebar col-lg-3 PCOnly">
							<div class="sidebar-widgets-wrap">
								...
								<div class="widget widget_links product_lbox">
									...
									<h4>會員中心</h4>
									<ul>
										<li><a href="member.html" title="會員總覽" class="active">會員總覽</a></li>
