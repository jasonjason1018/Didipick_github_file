		...
		<section id="content">
			<div class="content-wrap">
				<div class="container">
					...
					<div>
						<ul class="process-steps process-2 row justify-content-center mb-4">
							...
							<li class="col-xs-3 col-sm-3 col-lg-3">
								<a href="#" class="i-bordered i-circled mx-auto">2</a>
								<h5>填寫資料</h5>
							</li><li class="col-xs-3 col-sm-3 col-lg-3">
								<a href="#" class="i-bordered i-circled mx-auto">3</a>
								<h5>訂購完成</h5>
							</li>
						</ul>
					</div>
							...
							<tbody>
								<tr class="cart_item">
									...
									<td class="cart-product-thumbnail">
										<a href="product_info.html"><img width="64" height="64" src="images/product_img/proimg_1.jpg" alt="資生堂MOILIP藥用護唇膏"></a>
									</td>

									<td class="cart-product-name">
										<a href="product_info.html">資生堂MOILIP藥用護唇膏</a>
									</td>

									<td class="cart-product-price">
										<span class="amount">NT.300</span>
									</td>
									...
									<td class="cart-product-remove">
										<a href="#" class="remove" title="Remove"><i class="icon-trash2"></i></a>
									</td>
								</tr>
								<tr class="cart_item">
									<td class="cart-product-checkall">
									...
									<td class="cart-product-thumbnail">
										<a href="product_info.html"><img width="64" height="64" src="images/product_img/proimg_2.jpg" alt="Fujiko Ponpon Powder 頭髮"></a>
									</td>

									<td class="cart-product-name">
										<a href="product_info.html">Fujiko Ponpon Powder 頭髮</a>
									</td>
					...
					<div class="codebox">
						<div class=" codeleft">
							<input type="text" value="" class="sm-form-control" placeholder="輸入優惠碼..." />
						</div>
						<div class="coderight">
							<a href="#" class="button button-3d m-0">確認輸入</a>
						</div>
					</div>
					...
					<div class="row col-mb-30">
						<div class="col-lg-8">
							<h4 class="mb-3 t_didi_t">滿額免運看過來！</h4>
							<div class="w-100">
								<div class="borline">
									...
									<div id="oc-products" class="owlbox owl-carousel products-carousel carousel-widget" data-pagi="false" data-items-xs="2" data-items-sm="2" data-items-md="3" data-items-lg="4">
										...
										<div class="oc-item">
											<div class="product probox">
												<div class="product-image">
													<a href="#"><img src="images/product_img/proimg_2.jpg" alt="Fujiko Ponpon Powder 頭髮專用吸油粉撲"></a>
													<div class="addheartbox">
														<img src="images/product_heart.png" alt="">
													</div>
												</div>
										...
										<div class="oc-item">
											<div class="product probox">
												<div class="product-image">
													<a href="#"><img src="images/product_img/proimg_3.jpg" alt="EVE止痛藥"></a>
													<div class="addheartbox">
														<img src="images/product_heart.png" alt="">
													</div>
												</div>
										...
										<div class="oc-item">
											<div class="product probox">
												<div class="product-image">
													<a href="#"><img src="images/product_img/proimg_4.jpg" alt="Fujiko Ponpon Powder 頭髮專用吸油粉撲"></a>
													<div class="addheartbox">
														<img src="images/product_heart.png" alt="">
													</div>
												</div>
										...
										<div class="oc-item">
											<div class="product probox">
												<div class="product-image">
													<a href="#"><img src="images/product_img/proimg_2.jpg" alt="EVE止痛藥"></a>
													<div class="addheartbox">
														<img src="images/product_heart.png" alt="">
													</div>
												</div>
										...
										<div class="oc-item">
											<div class="product probox">
												<div class="product-image">
													<a href="#"><img src="images/product_img/proimg_3.jpg" alt="大馬士革玫瑰髮蠟"></a>
													<div class="addheartbox">
														<img src="images/product_heart.png" alt="">
													</div>
												</div>
							...
							<div class="h_40"></div>
							<h4 class="mb-3 t_didi_t">一次把慾望帶回家！</h4>
							<div class="w-100">
								<div class="borline">
									<div class="fancy-title">
										<h4>您的慾望清單:</h4>
									...
									<div id="oc-products" class="owlbox owl-carousel products-carousel carousel-widget" data-pagi="false" data-items-xs="2" data-items-sm="2" data-items-md="3" data-items-lg="4">
										...
										<div class="oc-item">
											<div class="product probox">
												<div class="product-image">
													<a href="#"><img src="images/product_img/proimg_1.jpg" alt="資生堂MOILIP藥用護唇膏"></a>
													<div class="addheartbox">
							...
							<div class="choutbox">
								...
								<div class="table-responsive">
									<table class="table cart cart-totals">
										<tbody>
											<tr class="cart_item">
												...
												<td class="cart-product-name">
													<span class="amount"><small>NT.</small> 900</span>
												</td>
											</tr>
											<tr class="cart_item">
												<td class="cart-product-name">
												...
												<td class="cart-product-name">
													<span class="amount"><small>NT.</small> 60</span>
												</td>
											</tr>
											<tr class="cart_item">
												<td class="cart-product-name">
												...
												<td class="cart-product-name">
													<span class="amount"><small>NT.</small> </span>
												</td>
											</tr>
											<tr class="cart_item">
												<td class="cart-product-name">
												...
												<td class="cart-product-name">
													<span class="amount color lead"><small>NT.</small> <strong>960</strong></span>
												</td>
											</tr>
										</tbody>
									...
									<div class="center checkoutbtn">
										<a href="checkout.html" class="button button-3d m-0">前往結帳</a>
									</div>
								</div>
							</div>
						</div>
