							...
							@foreach($product as $v)
								<div class="product probox col-md-3 col-sm-6 col-12">
									<div class="product-image">
										<a href="product_info.html"><img src="/storage/{{$v->img1}}" alt="{{$v->name}}"></a>
										<div class="liked" onclick="addheart('')" id="heart"></div>
										<div class="addheartbox">
											<img src="/storage/{{$v->img1}}" alt="" class="active">
										</div>
									</div>

									<div class="product-desc center">
										<div class="product-title"><h3><a href="product_info.html">{{$v->name}}</a></h3></div>
										@if($v->o_price == $v->s_price)
