								...
								<div class="page-menu-row">
									...
									<nav class="page-menu-nav">
										<ul class="page-menu-container">
											<li class="page-menu-item current"><a href="notice.html"><div>訂單通知</div></a></li>
								...
								<div class="toggle toggle-bg-w">
									<div class="toggle-header">
										<div class="toggle-title">
											<div class="togglesmall">訂單</div><h3>您的訂單已出貨囉！</h3>
									...
									<div class="toggle-content" style="display: none;">
										<p>感謝您的訂購，商品正在路上哦～<br>本次訂購恭喜您再次獲得50元購物金，可於下次購買時折抵使用。...</p>
									</div>
								</div>
						...
						<div class="sidebar col-lg-3 PCOnly">
							<div class="sidebar-widgets-wrap">
								...
								<div class="widget widget_links product_lbox">
									...
									<h4>通知總覽</h4>
									<ul>
										<li><a href="notice.html" title="訂單通知" class="active">訂單通知<b class="t_danger">・</b></a></li>
										<li><a href="#" title="主題活動">主題活動<b class="t_danger">・</b></a></li>
										<li><a href="#" title="訊息公告">訊息公告<b class="t_danger">・</b></a></li>
