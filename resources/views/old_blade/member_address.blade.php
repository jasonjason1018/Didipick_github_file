...
<head>
	...
	<title>收件地址管理｜直直買 didipick</title>
								...
								<div class="page-menu-row">
									...
									<nav class="page-menu-nav">
										<ul class="page-menu-container">
											...
											<li class="page-menu-item current"><a href="member_address.html" title="收件地址管理">收件地址管理</a></li>
											<li class="page-menu-item"><a href="order_ service.html" title="客服中心">客服中心</a></li>
												...
												<div class="chform">
													<form class="row mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post" novalidate="novalidate">
														...
														<div class="col-12 form-group">
															...
															<input type="text" id="template-contactform-name" name="template-contactform-name" value="" class="sm-form-control required" placeholder="請填寫真實姓名...">
														</div>
			
														<div class="col-12 form-group">
															<label for="template-contactform-phone">聯絡電話</label>
															<input type="text" id="template-contactform-phone" name="template-contactform-phone" value="" class="sm-form-control valid" placeholder="+886">
														...
														<div class="col-md-4 form-group">
															<input type="text" id="shipping-form-addressnumber" name="shipping-form-addressnumber" value="" class="sm-form-control" placeholder="郵遞區號">
														</div>
														<div class="col-md-4 form-group">
															<select id="shipping-form-addresscity" name="shipping-form-addresscity" class="sm-form-control valid">
														...
														<div class="col-md-4 form-group">
															<select id="shipping-form-addressarea" name="shipping-form-addressarea" class="sm-form-control valid">
														...
														<div class="col-md-12 form-group">
															<input type="text" id="shipping-form-addressstreet" name="shipping-form-addressstreet" value="" class="sm-form-control" placeholder="請選擇街道">
														</div>
														...
														<div class="row post-navigation membtnbox">
															...
															<div class="col-12 col-md-auto text-center">
																<a href="#" class="button button-rounded m-0">新增地址</a>
															</div>
														</div>
								...
								<div class="maddressbox">
									<div class="maddress_item active">
										<div class="maddress_l">
											<p>收件人：王小明</p>
											<p>聯絡電話：0920000000</p>
											<p>收件地址：115 台北市南港區南港路三段50巷16號3樓</p>
										</div>
										<div class="maddress_r">
											<div>
												<!-- <span class="preset_t"><a href="#">取消預設</a></span><span class="preset_t"><a href="#">刪除</a></span><br> -->
												<span><a href="#" class="button button-border button-rounded button-green">編輯</a></span>
											</div>
										</div>
									</div>

									<div class="maddress_item">
										<div class="maddress_l">
											<p>收件人：王小明</p>
											<p>聯絡電話：0927093000</p>
											<p>收件地址：105 台北市松山區南京東路四段186號</p>
										</div>
										<div class="maddress_r">
											<div>
												<span class="preset_t"><a href="#">設為預設</a></span><span class="preset_t"><a href="#">刪除</a></span><br>
												<span><a href="#" class="button button-border button-rounded button-green">編輯</a></span>
											</div>
										</div>
									</div>
							...
							<div class="sidebar-widgets-wrap">
								...
								<div class="widget widget_links product_lbox">
									...
									<ul>
										...
										<li><a href="member_address.html" title="收件地址管理" class="active">收件地址管理</a></li>
