								...
								<div class="page-menu-row">
									...
									<nav class="page-menu-nav">
										<ul class="page-menu-container">
											...
											<li class="page-menu-item current"><a href="member_password.html" title="更改密碼">更改密碼</a></li>
									...
									<div class="chform">
										<form class="row mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post" novalidate="novalidate">
											...
											<div class="col-12 form-group">
												...
												<input type="text" id="template-contactform-oldpassword" name="template-contactform-oldpassword" value="" class="sm-form-control required" placeholder="舊密碼">
											</div>

											<div class="col-12 form-group">
												<label for="template-contactform-newpassword">新密碼</label>
												<input type="text" id="template-contactform-newpassword" name="template-contactform-newpassword" value="" class="sm-form-control required" placeholder="請輸入新密碼">
												<small class="t_danger">*請輸入6個字元以上的英文字母及數字，不可使用特殊符號</small>
											</div>

											<div class="col-12 form-group">
												<label for="template-contactform-checkpassword">新密碼確認</label>
												<input type="text" id="template-contactform-checkpassword" name="template-contactform-checkpassword" value="" class="sm-form-control required" placeholder="請再次輸入新密碼">
											</div>
											...
											<div class="row post-navigation membtnbox">
												...
												<div class="col-12 col-md-auto text-center">
													<a href="#" class="button button-rounded m-0">確定修改</a>
												</div>
											</div>
							...
							<div class="sidebar-widgets-wrap">
								...
								<div class="widget widget_links product_lbox">
									...
									<ul>
										...
										<li><a href="member_password.html" title="更改密碼" class="active">更改密碼</a></li>
