								...
								<div class="page-menu-row">
									...
									<nav class="page-menu-nav">
										<ul class="page-menu-container">
											<li class="page-menu-item"><a href="qa.php"><div>常見問題</div></a></li>
											<li class="page-menu-item current"><a href="shoppingprocess.php"><div>購物流程</div></a></li>
						...
						<div class="postcontent col-lg-9 order-lg-last">
							<div class="qabox">
								...
								<div class="toggle toggle-bg">
									<a href="/didipick_articles/{{$qa->id}}">
