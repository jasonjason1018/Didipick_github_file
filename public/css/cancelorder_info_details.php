						...
						<div class="postcontent col-lg-9 order-lg-last">
							...
							<div class="orderdetails">
								...
								<div class="pricedetails">
									<ul>
										<li><span class="pdeitem_l">小計：</span><span class="pdeitem_r">NT <?=$row['total']?><span class="pdeitem_l"></li>
										...
										<li class="pdtotal pt-2"><span class="pdeitem_l">合計：</span><span class="pdeitem_r">NT <?=$row['total']+$row['freight']?></span></li>
									</ul>
