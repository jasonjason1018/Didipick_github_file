$(function() {
    ...
    $.getJSON('/json/primary_categ.json', function(data) {
        ...
        categAr.forEach(function(a) {
            ...
            _html += '<a class="link_area" href="category.html?category=' + a["first_id"] + '">' + a["first_name"] + '</a>';
            ...
            a['second_list'].forEach(function(b, i) {
                ...
                _html += '<a class="link_area" href="category.html?category=' + b["second_id"] + '">' + b["second_name"] + '</a>';
                _html += '</li>';
                ...
                b['third_list'].forEach(function(c) {
                    ...
                    _html += '<a class="link_area" href="category.html?category=' + c["third_id"] + '">' + c["third_name"] + '</a>';
                    _html += '</li>';
