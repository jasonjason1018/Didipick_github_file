$(function() {
    ...
    //---- 主商品分類選單
    $.getJSON('/json/primary_categ3.php', function(data) {
        var categAr = data,
            _html = '',
        ...
        categAr.forEach(function(a) {
            ...
            _html += '<a class="link_area" href="http://tokukai.com/yahoo_auction/category.php?category=' + a["first_id"] + '">' + a["first_name"] + '</a>';
            ...
            a['second_list'].forEach(function(b, i) {
                ...
                _html += '<a class="link_area" href="http://tokukai.com/yahoo_auction/category.php?category=' + b["second_id"] + '">' + b["second_name"] + '</a>';
                _html += '</li>';
                ...
                b['third_list'].forEach(function(c) {
                    ...
                    _html += '<a class="link_area" href="http://tokukai.com/yahoo_auction/category.php?category=' + c["third_id"] + '">' + c["third_name"] + '</a>';
                    _html += '</li>';
