$(function() {
    ...
    // ---- 主商品分類選單
    $.getJSON('/json/primary_categNT2.php', function(data) {
        var categAr = data,
            _html = '',
            _first_index = 0;
        ...
        categAr.forEach(function(a)
        {
            ...
            _html += '<a class="link_area" href="category.php?category=' + a["first_id"] + '">' + a["first_name"] + '</a>';
            ...
            a['second_list'].forEach(function(b) {
                ...
                _html += '<a class="link_area" href="category.php?category=' + b["second_id"] + '">' + b["second_name"] + '</a>';
                _html += '</li>';
            })
            _html += '</ul>';
