$(function() {
    ...
    //---- 主商品分類選單
    $.getJSON('/json/primary_categ3A.php', function(data) {
        var categAr = data,
            _html = '',
        ...
        categAr.forEach(function(a) {
            _first_index++;
            _html += _first_index > 15 ? '<li class="first_item z-second_row">' : '<li class="first_item">';
            _html += '<a class="link_area" href="http://tokukai.com/yahoo_auction/categoryA.php?category=' + a["first_id"] + '">' + a["first_name"] + '</a>';
            ...
            a['second_list'].forEach(function(b) {
                ...
                _html += '<a class="link_area" href="http://tokukai.com/yahoo_auction/categoryA.php?category=' + b["second_id"] + '">' + b["second_name"] + '</a>';
                ...
                b['third_list'].forEach(function(c) {
                    ...
                    _html += '<a class="link_area" href="http://tokukai.com/yahoo_auction/categoryA.php?category=' + c["third_id"] + '">' + c["third_name"] + '</a>';
                    _html += '</li>';
                }, this)
                _html += '</ul>';
                _html += '</div>';
